...
#RC patch to use Auth Token from Raidus
Patch8: pam_radius_auth.patch
...
%changelog
* Thu Apr 19 2012 Harvard University Research Computing <matthew_nicholson@harvard.edu> 1.3.17-3.RC
- Change Auth Token to Verification Code

* Fri Mar 16 2012 Matthew Nicholson <matthew_nicholson@harvard.edu> 1.3.17-2.RC
- Add patch to use Auth Token from Radius for OpenAuth 2 Factor
